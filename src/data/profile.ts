export const profile = {
  ...
  about: [
    ...
    'Mi interessano performance, accessibilità e codice mantenibile. Parallelamente sto approfondendo .NET/C# per costruire competenze full stack.',
    'Appartengo alle categorie protette ex L. 68/99, art. 1.',
  ],
  interests: [
    'React & TypeScript',
    'C# / .NET',
